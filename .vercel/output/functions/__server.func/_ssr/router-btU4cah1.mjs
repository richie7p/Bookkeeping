...
//#region node_modules/.nitro/vite/services/ssr/assets/router-btU4cah1.js
var router_btU4cah1_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
function Toaster$1(props) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toaster, {
		...
		toastOptions: { classNames: {
			toast: "bg-card text-card-foreground border-border shadow-border font-sans",
...
var styles_default = "/assets/styles-SenyWPKJ.css";
var APP_NAME = "Folio";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "按日記帳、帳戶餘額與支出類別，清楚的個人記帳工具。"
			},
			{
				name: "theme-color",
				content: "#f3efe6"
...
var $$splitComponentImporter = () => import("./routes-Cg3ZZJe3.mjs");
...
//#endregion
export { getRouter, router_btU4cah1_exports as t };
